...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Visitors GatePass Logs</h3>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
								...
								<td class="text-center"><?php echo $row['vehicleNum'] ?></td>
								<td>
									<p class="m-0">
										<small>
	...
	$(document).ready(function(){
		...
		$('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Visitors GatePass Logs List - Print View")
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">Visitors GatePass Logs List</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
