...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Registered GatePass Logs</h3>
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        ...
                        $qry = $conn->query("SELECT l.*,e.fullname,e.vehicleNum,e.department_id,e.designation_id,e.employee_code,e.date_updated FROM `logs` l inner join `employee_list` e on l.employee_id = e.id {$where}");
                        ...
                        ?>
                            <tr>
								...
								<td>
									<p class="m-0">
										<small>
											<span class="text-muted">Vehicle Plate No.: </span><span><?php echo $row['vehicleNum'] ?></span><br>
	...
	$(document).ready(function(){
		...
		$('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Registered GatePass Logs List - Print View")
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">Registered GatePass Logs List</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
