...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title">GatePass Details</h5>
    </div>
    <div class="card-body">
        <div class="container-fluid" id="print_out">
            ...
            <h3 class="text-info">GatePass RFID Number: <b><?php echo isset($employee_code) ? $employee_code :'' ?></b></h3>
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <dl>
                        ...
                        <dt class="text-info">Vehicle Plate Number:</dt>
                        <dd class="fw-bold pl-3"><?php echo isset($vehicleNum) ? $vehicleNum : "" ?></dd>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("GatePass Details - Print View")
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">GatePass Details</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
