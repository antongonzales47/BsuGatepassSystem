...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title"><?php echo isset($id) ? "Update GatePass Details - ".$employee_code : 'Add New GatePass' ?></h5>
    </div>
    <div class="card-body">
                ...
                <div class="col-md-12">
                    <fieldset class="border-bottom border-info">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                <label for="vehicleNum" class="control-label text-info">Vehicle Plate No.</label>
                                <input type="text" class="form-control form-control-sm rounded-0" id="vehicleNum" name="vehicleNum" value="<?php echo isset($vehicleNum) ? $vehicleNum : '' ?>" required>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">School Details</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
                    ...
                    <fieldset class="border-bottom border-info">
                        <legend class="text-info">Applicant Image</legend>
                        <div class="row">
                            <div class="form-group col-sm-4">
