...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Registered GatePass List</h3>
		<div class="card-tools">
			<a href="<?php echo base_url."admin?page=employee/manage_employee" ?>" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Add New GatePass</a>
		</div>
	</div>
	<div class="card-body">
