    ...
    <div class="row justify-content-center">
        ...
        <div class="card card-primary card-tabs">
            ...
            <ul class="nav nav-tabs" id="panel-tab" role="tablist">
                <li class="nav-item">
                <a class="nav-link active" id="custom-tabs-one-employees-tab" data-toggle="pill" href="#custom-tabs-one-employees" role="tab" aria-controls="custom-tabs-one-employees" aria-selected="true">Registered IDs</a>
                </li>
                <li class="nav-item">
                               ...
                               <div class="row justify-content-center">
                                   <div class="col-md-8">
                                       <div class="form-group text-center">
                                           <label for="employee_code">Please Enter your Vehicle RFID Number.</label>
                           ...
                           <div class="col-12">
                               <div class="row justify-content-center">
                                   <div class="col-md-8">
                                       ...
                                       <div class="form-group text-center">
                                           <label for="address">Vehicle Plate Number</label>
                                           <input type="text" id="vehicleNum" name="vehicleNum" class="form-control form-control-lg rounded-0" autocomplete="off">  
                                       </div>
                                       <div class="form-group text-center">
